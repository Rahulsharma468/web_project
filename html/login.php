            ...
            <div class="signin">
                <form action="login_backend.php" method="POST" name="f1" class="sign-in-form" >
                    ...
                    <div class="input-field">
                        ...
                        <input type="name" name="username" id="userSIEmail" autocomplete="off" class="uname" placeholder="Enter username" required>
                    </div>

                    <div class="input-field">
                        <i class="fas fa-lock"></i>
                        <input type="password" name="password" id="userSIPassword" autocomplete="off" placeholder="Enter Password" required>
                    </div>
